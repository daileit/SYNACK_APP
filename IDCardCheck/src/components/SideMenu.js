...
export default class SideMenu extends Component {
    constructor(props) {
        ...
        this.dataMenu = [
            { title: 'd', route: 'side_Flight', icon: Images.icFlight },
            { title: 'c', route: 'side_Hotels', icon: Images.icHotels },
            // { title: 'Tranfers', route: 'side_Flightxxx', icon: Images.icCarSoftBlue },
            { title: 'b', route: 'side_Flightxxx', icon: Images.icGroundeServices },
            // { title: 'Deals', route: 'side_Flightxxx', icon: Images.icDealsSoftBlue },
            { title: 'a', route: 'side_Blog', icon: Images.icBlogs, toggle: true },
        ];
        this.dataBlog = [
